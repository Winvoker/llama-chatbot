...
{
  "text": [
    " The first law of thermodynamics, also known as the energy conservation principle, states that energy cannot be created or destroyed, only converted from one form to"
  ]
}
```
